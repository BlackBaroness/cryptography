...
class Blake2bTest {
    ...
    void _160() {
        assertEquals(
                ...
                blake2b._160().hash(HashSources.ofString("testing")).string()
        );
    }
    ...
    void _256() {
        assertEquals(
                ...
                blake2b._256().hash(HashSources.ofString("testing")).string()
        );
    }
    ...
    void _384() {
        assertEquals(
                ...
                blake2b._384().hash(HashSources.ofString("testing")).string()
        );
    }
    ...
    void _512() {
        assertEquals(
                ...
                blake2b._512().hash(HashSources.ofString("testing")).string()
        );
    }
}